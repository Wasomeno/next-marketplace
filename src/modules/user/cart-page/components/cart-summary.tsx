...
export const CartSummary = ({ selectedItems }: CartCheckoutDialogProps) => {
  ...
  return (
    <div className="sticky bottom-0 w-full bg-white dark:bg-neutral-950 lg:w-2/6 lg:px-8">
      <div className="border-t border-gray-200 p-2.5 shadow-[0_3px_10px_rgb(0,0,0,0.1)] dark:border-t-gray-800 lg:rounded-md lg:border lg:border-gray-200 lg:p-4 lg:shadow-none lg:dark:border-gray-800">
