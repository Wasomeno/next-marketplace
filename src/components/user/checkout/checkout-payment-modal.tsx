          ...
          <>
            ...
            <div className="flex flex-1 flex-col">
                ...
                <div className="mt-2 flex w-full flex-col gap-2">
                  {paymentMethods.map((method) => (
                    <Button
                      ...
                      key={method.id}
                      className="flex items-center justify-between rounded-md border shadow-sm dark:border-neutral-700 dark:bg-neutral-800"
                    >
                      ...
                      <Input
                        ...
                        type="radio"
                        className="h-3 w-3 border border-slate-50"
                      />
                    </Button>
                  ))}
                </div>
              ...
              <div className="border-t p-4 dark:border-t-neutral-700">
                <div className="mb-2">
                  <h5 className="text-sm font-semibold tracking-wide">Total</h5>
